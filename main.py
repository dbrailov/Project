...
# embedded_sequences = GaussianNoise(100.0, input_shape=(MAX_SEQUENCE_LENGTH,))(embedded_sequences)
# x = Conv1D(128, 5, activation='sigmoid', use_bias=True)(embedded_sequences)
# x = MaxPooling1D(5)(x)
# x = Conv1D(128, 5, activation='sigmoid', use_bias=True)(x)
# x = MaxPooling1D(5)(x)
# x = Conv1D(128, 5, activation='sigmoid', use_bias=True)(x)
