...
plt.savefig('1_3_plot.png', dpi=600)
plt.show()

with open('1_3_conv2_quantile.csv', 'a') as f:
    np.savetxt(f, df2q)
with open('1_3_conv4_quantile.csv', 'a') as f:
    np.savetxt(f, df4q)
with open('1_3_conv6_quantile.csv', 'a') as f:
    np.savetxt(f, df4q)
    ############################################
with open('1_3_conv2.csv','a') as f:
    np.savetxt(f, arr2, delimiter=",")
with open('1_3_conv4.csv','a') as f:
    np.savetxt(f, arr4, delimiter=",")
with open('1_3_conv6.csv','a') as f:
