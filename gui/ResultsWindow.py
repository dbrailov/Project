...
class Ui_ResultsWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_variationCoefficientPlot = QtWidgets.QPushButton(self.splitter)
        self.pushButton_histogramPlot = QtWidgets.QPushButton(self.splitter)
        self.pushButton_variationCoefficientPlot.setObjectName("pushButton_variationCoefficientPlot")
        ...
        self.pushButton_variationCoefficientPlot.raise_()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_variationCoefficientPlot.setText(_translate("Results", "Coefficient Of Variation Plot"))
        self.pushButton_histogramPlot.setText(_translate("Results", "Coefficient Of Variation Histogram Plot"))
...
###################################################################################################
        ...
        self.pushButton_variationCoefficientPlot.clicked.connect(self.pushButton_variationCoefficientPlot_handler)
    ...
    def pushButton_lossPlot_handler(self):
        ...
        os.chdir(retval)
    def pushButton_variationCoefficientPlot_handler(self):
        retval = os.getcwd()
        os.chdir('../results/last')
        os.system('VariationCoefficientPlot.png')
        os.chdir(retval)
